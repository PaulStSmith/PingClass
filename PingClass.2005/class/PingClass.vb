...
Public Class PingClass
    ...
    Private Const PING_ERROR_BASE As Integer = &H8000

    ''' <summary>
    ''' An enumerator of the possible errors that might occur when pinging a remote host.
    ''' </summary>
    Public Enum pingErrorCodes As Integer
        ...
        HostNotResponding
        TimeOut
        BufferTooSmall = PING_ERROR_BASE + &H101
    ...
    ''' <summary>
    ''' Holds the information gathered by the asynchronous ping request.
    ''' </summary>
    ...
    ''' <summary>
    ''' Holds the information needed during the asynchronous ping request.
    ''' </summary>
    ...
    ''' <summary>
    ''' A Delegate function that will be called when the asynchronous ping completes.
    ''' </summary>
    ''' <param name="par">A PingAsyncResult object that contains information about the asynchronous operation.</param>
    Public Delegate Sub PingCallback(ByVal par As PingAsyncResult)

    ''' <summary>
    ''' The amount of time in miliseconds in which the remote host mest repply.
    ''' </summary>
    ...
    ''' <summary>
    ''' The size of the package to be send on the ping request. Default 32 bytes.
    ''' </summary>
    ...
    ''' <summary>
    ''' ReadOnly. A System.Net.IPHostEntry that represents the local computer.
    ''' </summary>
    ...
    ''' </summary>
    Public Property RemoteHost() As System.Net.IPHostEntry
        Get
            Return __RemoteHost
        End Get
    ...
    ''' </summary>
    ''' <param name="fqdnHostName">The Full Qualified Doman Name of the host to be pinged.</param>
    Public Overloads Sub SetRemoteHost(ByVal fqdnHostName As String)
        ...
        '*
        Try
            RemoteHost = System.Net.Dns.GetHostEntry(fqdnHostName)
        Catch
            RemoteHost = Nothing
    ...
    ''' <param name="ipHost">A System.Net.IPAddress that represents the remote host to be pinged.</param>
    Public Overloads Sub SetRemoteHost(ByVal ipHost As System.Net.IPAddress)
        ...
        '*
        Try
            RemoteHost = System.Net.Dns.GetHostEntry(ipHost)
        Catch
            RemoteHost = Nothing
            __Error = pingErrorCodes.HostNotFound 'PING_ERROR_HOST_NOT_FOUND
        End Try
    ...
    Public Sub New()
        ...
        '*
        __LocalHost = System.Net.Dns.GetHostEntry(System.Net.Dns.GetHostName())
    ...
    ''' <summary>
    ''' Pings the remote host and return the number of miliseconds that the host took to repply.
    ''' </summary>
    ''' *
    ''' *   Function : PingHost
    ''' *     Author : Paulo Santos
    ...
    ''' <summary>
    ''' Pings a Full Qualified Domain Name and return the number of miliseconds that the host took to repply.
    ''' </summary>
    ''' <param name="fqdnHostName">The Full Qualified Doman Name of the host to be pinged.</param>
    ...
    ''' <summary>
    ''' Pings an IP address and return the number of miliseconds that the host took to repply.
    ''' </summary>
    ''' <param name="ipAddress">A System.Net.IPAddress that represents the remote host to be pinged.</param>
    ...
    ''' <summary>
    ''' The last error occured when pinging a host.
    ''' </summary>
    ...
    ''' </summary>
    ''' <param name="fqdnHostName">The Full Qualified Doman Name of the host to be pinged.</param>
    ''' <param name="requestCallback">A PingCallback Delegate which will be called upon the repply.</param>
    ''' <param name="stateObject">A generic user object.</param>
    ...
    ''' </summary>
    ''' <param name="par">The PingAsyngResult object that holds the state information for the asynchronous operation.</param>
